...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">مرحباً  {{ Auth::user()->name }}   ، أهلا بعودتك </h2>
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    {{ number_format(\App\invoices::sum('Total'), 2) }} <small>SAR</small>
                                </h4>
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h3 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    {{ number_format(\App\invoices::where('Value_Status', 2)->sum('Total'), 2) }} <small>SAR</small>
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    {{ number_format(\App\invoices::where('Value_Status', 1)->sum('Total'), 2) }} <small>SAR</small>
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    {{ number_format(\App\invoices::where('Value_Status', 3)->sum('Total'), 2) }} <small>SAR</small>
