...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ url('/' . ($page = 'home')) }}"> MAZEN</a>
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">دافتر الفواتير</li>
            <li class="slide">
            ...
            @endcan
            @can('التقارير')
                <li class="side-item side-item-category">البريد الإليكتروني</li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                            xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                        ...
                        </svg><span class="side-menu__label">البريد الإليكتروني</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        @can('تقرير الفواتير')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'send-email')) }}"> إرسال بريد</a>
                            </li>
                        @endcan

                        @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'sent-email')) }}"> البريد المرسل</a>
                            </li>
                        @endcan
                    </ul>
                </li>
